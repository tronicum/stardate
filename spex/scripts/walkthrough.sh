...
note "Every tileset above also got a colored ASCII view for free — try"
note "\`spex ascii <tileset dir>\` (add --animate for a turntable orbit,"
note "or --animate --out view.html for a self-contained animated HTML file)."
